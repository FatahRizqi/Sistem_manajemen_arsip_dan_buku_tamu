    ...
    return (
        <div className="card shadow-2 border-1 surface-border border-round-xl p-4 bg-white">
            <div className="flex flex-column gap-2 mb-4 px-1">
                <h3 className="text-2xl font-semibold m-0 text-900">Manajemen Jadwal Retensi Arsip</h3>
                <div className="text-sm text-600">
                    Kelola jadwal retensi untuk menentukan berapa lama arsip disimpan berdasarkan kategori dokumen dan tindakan yang harus dilakukan setelah masa retensi berakhir.
                </div>
            </div>
